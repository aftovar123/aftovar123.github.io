...
const translations = {
  ...
  en: {
    ...
    "projects.p5Badge": "REST API · Clean Architecture",
    "projects.p5Title": "AssetSync — Asset Sync with the Outbox Pattern",
    "projects.p5Desc": "C#/.NET API for asset and work order management, built with Clean Architecture, CQRS (MediatR), and the Transactional Outbox pattern for reliable syncing with an external ERP/SAP-style system: Polly retries, FluentValidation, global error handling, health checks, and a live API testing interface (Scalar). 34 automated tests with xUnit and Moq.",
