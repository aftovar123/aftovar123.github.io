...
const translations = {
  es: {
    ...
    "projects.p4Desc": "Catálogo de videojuegos construido en Flutter con Clean Architecture (domain/data/presentation), manejo de estado con Cubit, consumo de la API pública de RAWG, paginación infinita e internacionalización ES/EN, con 19 tests automatizados.",
  ...
  en: {
    ...
    "projects.p4Desc": "Video game catalog built in Flutter with Clean Architecture (domain/data/presentation), Cubit state management, integration with the public RAWG API, infinite pagination and ES/EN internationalization, with 19 automated tests.",
