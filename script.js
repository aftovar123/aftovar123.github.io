...
const translations = {
  ...
  en: {
    ...
    "projects.p4Desc": "Video game catalog built in Flutter applying Clean Architecture (domain/data/presentation) across two full features, with a personal diary persisted locally (Hive), Cubit state management, integration with the public RAWG API, ES/EN internationalization, and 73 automated tests across 5 layers.",
