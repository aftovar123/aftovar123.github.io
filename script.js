...
const translations = {
  ...
  en: {
    ...
    "about.body": "Systems Engineer from Universidad del Norte (2024) with 4+ years of experience in Oracle and SQL Server databases, full stack development in C#, React, and Angular, mobile apps with Flutter, and enterprise system integration. Skilled in web services, triggers, jobs, and optimized schemas. Deep knowledge of asset management application workflows, covering inventory, preventive and corrective maintenance, purchasing, and personnel. Recognized for integrating maintenance platforms with SAP, improving data synchronization and reducing manual work.",
