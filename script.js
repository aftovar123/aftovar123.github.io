...
const translations = {
  es: {
    ...
    "meta.title": "Andrés Tovar Sandoval — Ingeniero de Sistemas | Full Stack & Integraciones",
    "meta.description": "Portafolio de Andrés Felipe Tovar Sandoval, Ingeniero de Sistemas especializado en desarrollo full stack, aplicaciones móviles con Flutter, bases de datos Oracle/SQL Server e integración de sistemas empresariales.",
    "nav.about": "Sobre mí",
    ...
    "hero.tagline": "Desarrollo full stack en C#, React y Angular, aplicaciones móviles con Flutter, administración de bases de datos Oracle/SQL Server e integración de sistemas empresariales. Enfocado en soluciones eficientes, escalables y bien documentadas.",
    "hero.btnProjects": "Ver proyectos",
    "hero.btnCv": "Descargar CV",
    "hero.btnContact": "Contactar",
    "about.eyebrow": "Perfil",
    "about.heading": "Sobre mí",
    "about.body": "Ingeniero de Sistemas de la Universidad del Norte (2024) con más de 4 años de experiencia en bases de datos Oracle y SQL Server, desarrollo full stack en C#, React y Angular, aplicaciones móviles con Flutter, e integración de sistemas empresariales. Experto en servicios web, triggers, jobs y esquemas optimizados. Con amplio conocimiento en el flujo de aplicaciones de mantenimiento de activos, abarcando inventarios, mantenimiento preventivo y correctivo, compras y personal. Destacado por integrar plataformas de mantenimiento con SAP, mejorando la sincronización de datos y reduciendo tareas manuales. Aplico el mismo estándar en cada proyecto: arquitectura limpia, pruebas automatizadas y código mantenible.",
    "about.factLocationLabel": "Ubicación",
    "about.factExperienceLabel": "Experiencia",
    "about.factExperienceValue": "+4 años en full stack, móvil (Flutter) & bases de datos",
    ...
    "skills.frontendMobileTitle": "Frontend & Móvil",
    "skills.toolsTitle": "Herramientas",
    "skills.softwareDesignTitle": "Diseño de software",
    "skills.designPatterns": "Patrones de diseño",
    "skills.unitTesting": "Pruebas unitarias",
    "skills.codeReview": "Revisión de código",
    ...
    "experience.bullet5": "<strong>Diseño de software y calidad:</strong> aplicación de principios SOLID y Clean Architecture/CQRS en nuevos desarrollos con Entity Framework, con pruebas unitarias y revisión de código como parte del proceso de entrega.",
    ...
    "projects.p4Badge": "Aplicación móvil",
    "projects.p4Title": "Questlog — Catálogo de videojuegos",
    "projects.p4Desc": "Catálogo de videojuegos construido en Flutter aplicando Clean Architecture (domain/data/presentation) en dos features completas, con diario personal persistido localmente (Hive), estadísticas calculadas en vivo sobre esos datos, manejo de estado con Cubit, consumo de la API pública de RAWG, CI en GitHub Actions, internacionalización ES/EN, y 92 tests automatizados en 5 capas.",
    "projects.viewRepo": "Ver repositorio ↗",
    "projects.p5Badge": "API REST · Clean Architecture · Azure",
    "projects.p5Title": "AssetSync — Sincronización de activos con patrón Outbox",
    "projects.p5Desc": "API en C#/.NET para gestión de activos y órdenes de trabajo, con Clean Architecture, CQRS (MediatR) y el patrón Transactional Outbox para sincronizar de forma confiable con un sistema externo tipo ERP/SAP: reintentos con Polly, validación con FluentValidation, manejo global de errores y health checks. Desplegada en producción en Azure (App Service + Azure SQL) con CI/CD real desde GitHub Actions. 35 tests automatizados con xUnit y Moq.",
    "projects.p5Live": "Ver API en vivo ↗",
    ...
    "contact.body": "Disponible para trabajos freelance de desarrollo full stack, aplicaciones móviles con Flutter, integración de sistemas y automatización de procesos.",
    "contact.btnEmail": "Escríbeme un correo",
    "footer.built": "Hecho con GitHub Pages",
  },
  en: {
    "a11y.skipToContent": "Skip to content",
    "meta.title": "Andrés Tovar Sandoval — Systems Engineer | Full Stack & Integrations",
    "meta.description": "Portfolio of Andrés Felipe Tovar Sandoval, Systems Engineer specialized in full stack development, mobile apps with Flutter, Oracle/SQL Server databases, and enterprise system integration.",
    "nav.about": "About",
    "nav.skills": "Skills",
    ...
    "hero.tagline": "Full stack development in C#, React, and Angular, mobile apps with Flutter, Oracle/SQL Server database administration, and enterprise system integration. Focused on efficient, scalable, and well-documented solutions.",
    "hero.btnProjects": "View projects",
    "hero.btnCv": "Download CV",
    "hero.btnContact": "Get in touch",
    "about.eyebrow": "Profile",
    "about.heading": "About me",
    "about.body": "Systems Engineer from Universidad del Norte (2024) with 4+ years of experience in Oracle and SQL Server databases, full stack development in C#, React, and Angular, mobile apps with Flutter, and enterprise system integration. Skilled in web services, triggers, jobs, and optimized schemas. Deep knowledge of asset management application workflows, covering inventory, preventive and corrective maintenance, purchasing, and personnel. Recognized for integrating maintenance platforms with SAP, improving data synchronization and reducing manual work. I apply the same standard to every project: clean architecture, automated testing, and maintainable code.",
    "about.factLocationLabel": "Location",
    "about.factExperienceLabel": "Experience",
    "about.factExperienceValue": "4+ years in full stack, mobile (Flutter) & databases",
    ...
    "skills.frontendMobileTitle": "Frontend & Mobile",
    "skills.toolsTitle": "Tools",
    "skills.softwareDesignTitle": "Software design",
    ...
    "experience.bullet5": "<strong>Software design & quality:</strong> applied SOLID principles and Clean Architecture/CQRS to new development with Entity Framework, with unit testing and code review as part of the delivery process.",
    ...
    "projects.p4Badge": "Mobile app",
    "projects.p4Title": "Questlog — Game Catalog",
    "projects.p4Desc": "Video game catalog built in Flutter applying Clean Architecture (domain/data/presentation) across two full features, with a personal diary persisted locally (Hive), live stats computed from that data, Cubit state management, integration with the public RAWG API, CI on GitHub Actions, ES/EN internationalization, and 92 automated tests across 5 layers.",
    "projects.viewRepo": "View repository ↗",
    "projects.p5Badge": "REST API · Clean Architecture · Azure",
    "projects.p5Title": "AssetSync — Asset Sync with the Outbox Pattern",
    "projects.p5Desc": "C#/.NET API for asset and work order management, built with Clean Architecture, CQRS (MediatR), and the Transactional Outbox pattern for reliable syncing with an external ERP/SAP-style system: Polly retries, FluentValidation, global error handling, and health checks. Deployed to production on Azure (App Service + Azure SQL) with real CI/CD from GitHub Actions. 35 automated tests with xUnit and Moq.",
    "projects.p5Live": "View live API ↗",
    ...
    "contact.body": "Available for freelance work in full stack development, mobile apps with Flutter, systems integration, and process automation.",
