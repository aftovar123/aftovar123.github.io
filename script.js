...
const translations = {
  es: {
    ...
    "meta.description": "Portafolio de Andrés Felipe Tovar Sandoval, Ingeniero de Sistemas especializado en desarrollo full stack, bases de datos Oracle/SQL Server e integración de sistemas empresariales.",
    "nav.about": "Sobre mí",
    ...
    "hero.tagline": "Desarrollo full stack en C#, administración de bases de datos Oracle/SQL Server e integración de sistemas empresariales. Enfocado en soluciones eficientes, escalables y bien documentadas.",
    ...
    "about.factExperienceValue": "+4 años en full stack & bases de datos",
    ...
    "contact.body": "Disponible para trabajos freelance de desarrollo full stack, integración de sistemas y automatización de procesos.",
  ...
  en: {
    ...
    "meta.description": "Portfolio of Andrés Felipe Tovar Sandoval, Systems Engineer specialized in full stack development, Oracle/SQL Server databases, and enterprise system integration.",
    "nav.about": "About",
    "nav.skills": "Skills",
    ...
    "hero.tagline": "Full stack development in C#, Oracle/SQL Server database administration, and enterprise system integration. Focused on efficient, scalable, and well-documented solutions.",
    "hero.btnProjects": "View projects",
    "hero.btnCv": "Download CV",
    "hero.btnContact": "Get in touch",
    "about.eyebrow": "Profile",
    "about.heading": "About me",
    "about.body": "Systems Engineer from Universidad del Norte (2024) with 4+ years of experience in Oracle and SQL Server databases, full stack development in C#, and enterprise system integration. Skilled in web services, triggers, jobs, and optimized schemas. Deep knowledge of asset management application workflows, covering inventory, preventive and corrective maintenance, purchasing, and personnel. Recognized for integrating maintenance platforms with SAP, improving data synchronization and reducing manual work.",
    "about.factLocationLabel": "Location",
    "about.factExperienceLabel": "Experience",
    "about.factExperienceValue": "4+ years in full stack development & databases",
    ...
    "contact.body": "Available for freelance work in full stack development, systems integration, and process automation.",
